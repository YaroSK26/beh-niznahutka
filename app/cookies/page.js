      ...
      <div className="container mx-auto max-w-3xl px-4 py-16">
        ...
        <article className="space-y-8 text-white/90 leading-relaxed">
          <section>
            ...
            <p>
              Cookies sú malé textové súbory, ktoré webová stránka ukladá do
              vášho prehliadača. Umožňujú stránke zapamätať si vaše nastavenia
              alebo sledovať správanie pre analytické účely.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-[#19ff7d] mb-3">
              Cookies na tejto stránke
            </h2>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-[#19ff7d]/20">
                    <th className="text-left px-4 py-3 text-[#19ff7d] font-semibold">
                      Názov
                    </th>
                    <th className="text-left px-4 py-3 text-[#19ff7d] font-semibold">
                      Poskytovateľ
                ...
                <tbody>
                  <tr>
                    <td className="px-4 py-3 font-mono text-xs" colSpan={4}>
                      <span className="text-[#19ff7d]">Žiadne cookies</span> -
                      Vercel Analytics je cookieless. Zbiera iba anonymizované
                      agregované štatistiky (krajina, zariadenie, stránka).
                      Nevyžaduje súhlas podľa ePrivacy.
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <h3 className="text-lg font-semibold text-white mb-2 mt-6">
              Google Maps (iba po udelení súhlasu)
            </h3>
            <p className="text-sm text-white/70 mb-3">
              Tieto cookies nastaví Google pri načítaní vložených máp. Načítajú
              sa <strong>iba ak súhlasíte s cookies</strong>.
            </p>
                  ...
                  <tbody className="divide-y divide-[#19ff7d]/10">
                    <tr>
                      ...
                      <td className="px-4 py-3 text-xs">
                        Ukladá preferencie súhlasu používateľa
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-3 text-xs">Google LLC</td>
                      <td className="px-4 py-3 text-xs">
                        Nastavenia súhlasu s cookies (Google)
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-3 text-xs">Google LLC</td>
                      <td className="px-4 py-3 text-xs">
                        Personalizácia obsahu a reklám Google
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-3 text-xs">Google LLC</td>
                      <td className="px-4 py-3 text-xs">
                        Štatistiky a ochrana pred zneužitím
                      </td>
          ...
          <section>
            ...
            <p>
              Pri prvej návšteve zobrazíme lištu s možnosťou{" "}
              <strong>Prijať</strong> alebo <strong>Odmietnuť</strong> cookies
              tretích strán. Váš výber sa uloží lokálne v prehliadači (
              <code className="text-[#19ff7d] text-xs bg-black/30 px-1 py-0.5 rounded">
                localStorage
              </code>
              ) - nie je to cookie.
            </p>
            <p className="mt-2">
              Súhlas môžete kedykoľvek odvolať vymazaním údajov prehliadača
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-sm">
              <li>
                <strong>Chrome:</strong> Nastavenia → Súkromie a zabezpečenie →
                Súbory cookie a iné údaje stránok
              </li>
              <li>
                <strong>Firefox:</strong> Nastavenia → Súkromie a zabezpečenie →
              ...
              <li>
                <strong>Edge:</strong> Nastavenia → Súkromie, vyhľadávanie a
                služby → Súbory cookie
              </li>
            </ul>
          </section>
        </article>
